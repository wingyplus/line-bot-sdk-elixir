...
defmodule LINE.Bot.MessagingApi.Model.FlexMessage do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :altText => String.t(),
          :contents => LINE.Bot.Model.FlexContainer.t()
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:contents, :struct, LINE.Bot.MessagingApi.Model.FlexContainer)
  end
end
