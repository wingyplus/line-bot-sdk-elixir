...
defmodule LINE.Bot.MessagingApi.Model.ImageCarouselTemplate do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :type => String.t(),
          :columns => [LINE.Bot.Model.ImageCarouselColumn.t()]
        }
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:columns, :list, LINE.Bot.MessagingApi.Model.ImageCarouselColumn)
  end
end
