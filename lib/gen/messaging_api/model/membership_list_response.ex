...
defmodule LINE.Bot.MessagingApi.Model.MembershipListResponse do
  @moduledoc """
  List of memberships
  """
  ...
  @type t :: %__MODULE__{
          :memberships => [LINE.Bot.Model.Membership.t()]
        }
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:memberships, :list, LINE.Bot.MessagingApi.Model.Membership)
  end
end
