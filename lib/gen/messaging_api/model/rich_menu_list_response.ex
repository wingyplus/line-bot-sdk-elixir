...
defmodule LINE.Bot.MessagingApi.Model.RichMenuListResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          :richmenus => [LINE.Bot.Model.RichMenuResponse.t()]
        }
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:richmenus, :list, LINE.Bot.MessagingApi.Model.RichMenuResponse)
  end
end
