...
defmodule LINE.Bot.Webhook.Model.BeaconEvent do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :replyToken => String.t(),
          :beacon => LINE.Bot.Model.BeaconContent.t()
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:beacon, :struct, LINE.Bot.Webhook.Model.BeaconContent)
  end
end
