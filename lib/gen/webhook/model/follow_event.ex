...
defmodule LINE.Bot.Webhook.Model.FollowEvent do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          :replyToken => String.t(),
          :follow => LINE.Bot.Model.FollowDetail.t()
        }
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:follow, :struct, LINE.Bot.Webhook.Model.FollowDetail)
  end
end
