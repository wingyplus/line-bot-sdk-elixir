...
defmodule LINE.Bot.Webhook.Model.ModuleContent do
  ...
  def decode(value) when is_map(value) and not is_struct(value) do
    case Map.get(value, "type") do
      "attached" ->
        Deserializer.raw_to_struct(value, LINE.Bot.Webhook.Model.AttachedModuleContent)

      "detached" ->
        Deserializer.raw_to_struct(value, LINE.Bot.Webhook.Model.DetachedModuleContent)
